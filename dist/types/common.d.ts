    ...
    features: Array<{
        ...
        properties: {
            geocoding: {
                ...
                type: "house" | "street" | "district" | "city" | "county" | "state" | "country" | "locality" | string;
 ...
 */
export type SearchAndLookupResponse<F extends OutputFormat = "jsonv2"> = F extends "json" ? StandardJsonResponse[] : F extends "jsonv2" ? JsonV2Response[] : F extends "geojson" ? GeoJsonResponse : F extends "geocodejson" ? GeocodeJsonResponse : string;
export type ReverseResponsePayload<F extends OutputFormat = "jsonv2"> = F extends "json" ? StandardJsonResponse : F extends "jsonv2" ? JsonV2Response : F extends "geojson" ? GeoJsonResponse : F extends "geocodejson" ? GeocodeJsonResponse : string;
/**
